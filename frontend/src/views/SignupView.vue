  ...
  <div class="signup-page">
    <div class="panel">
      ...
      <div v-if="!done" class="form">
        ...
        <template v-if="step === 1">
          ...
          <p class="currency-note">
            Prices shown in {{ currencyLabel }} — billed only if you upgrade after the trial.
          </p>
        ...
        <template v-if="step === 2">
          ...
          <p class="trial-note">
            You'll start on a free 14-day trial. Add a card later only if you choose to upgrade.
          </p>

          <div class="step2-actions">
            <button class="btn-back" type="button" :disabled="loading" @click="step = 1">← Back</button>
            <button class="btn" type="button" :disabled="loading || !step2Valid" @click="onSubmit">
      ...
      <div v-if="done" class="done-state">
        ...
        <p>Your 14-day free trial has started. Redirecting to your dashboard...</p>
      </div>
...
import { COUNTRIES, findCountry, getOtherCountries, getPriorityCountries } from '@/data/countries'
